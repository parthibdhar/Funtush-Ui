        ...
        <div className="container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8">
          ...
          <div className="col-span-2 md:grid grid-cols-5 gap-4 items-center">
            <div className="col-span-3 flex flex-col gap-10">
              ...
              <div className="flex justify-between items-center  p-4 bg-main border border-gray-800 rounded-lg">
                {/* Share */}
                <div className="">
                  <button className="w-10 h-10 flex-colo rounded-lg bg-white bg-opacity-20 transitions hover:bg-subMain hover:text-main">
                    <FaShareAlt  />
                  </button>
                </div>
                {/* Language */}
                ...
                {/* Watch Button */}
                <div className="w-36 flex justify-end font-medium text-sm">
                  <Link
                    to={`/watch/${movie?.name}`}
                    className="bg-main py-4 hover:bg-subMain hover:text-main hover:font-bold transitions  border border-subMain rounded-full flex-rows gap-4 w-full sm:py-4 "
                  >
            ...
            <div className="col-span-2 md:mt-0 mt-2 flex justify-end ">
              <button className="md:w-1/4 w-full relative flex-colo bg-subMain hover:bg-transparent border-2 border-subMain transitions md:h-64 h-20 rounded font-medium">
                <div className="flex-rows gap-6 text-md uppercase tracking-widest absolute md:rotate-90">
                  Download <FiLogIn className="w-6 h-6 md:rotate-270" />
                </div>
              </button>
            </div>
          </div>
